...
import {
  ResetSystemDataDto,
  UpdateSettingsDto,
} from '../dtos/settings/setting.dto';
...
export class SettingsController {
  ...
  @ApiOperation({
    summary: 'Xóa toàn bộ dữ liệu hệ thống sau khi xác thực lại mật khẩu Admin',
  })
  async resetData(
    ...
    return {
      message:
        'Đã xóa toàn bộ dữ liệu hệ thống! Chỉ giữ lại Danh mục và Tài khoản Admin.',
    };
  }
